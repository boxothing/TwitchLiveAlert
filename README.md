...
## [생방알리미 v2.0 다운로드](https://github.com/boxothing/TwitchLiveAlert/releases/download/v2.0/TwitchLiveAlert-2.0.zip)
...
알림을 받을 수 있는 숫자나 시간 같은 특별한 제한은 없고 원하는 스트리머의 아이디만 입력하면 알림을 받을 수 있읍니다
...
다만 속성 알림의 경우 스터리머의 채널을 개별적으로 확인해기 때문에 트위치 API 서버에 무리가 갈수 있으니 목록은 30명을 초과하지 않도록 권장합니다

생방알리미는 파이썬(Python 3.7.6)을 기반으로 만들어졌읍니다
...
4. [`[일반] 알림목록.txt` 목록](#일반-알림목록.txt-목록-파일) 파일에 알림을 받을 스트리머의 아이디를 한줄에 한명씩 추가해 주세요
